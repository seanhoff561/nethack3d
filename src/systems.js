...
N.defaults={numberPad:true,minimalUI:false,autoOpenDoors:true,autopickup:true,sortInventory:true,pauseOnHunger:true,pauseOnBurden:true,pauseOnLowHP:true,sound:true,quality:'high'};
