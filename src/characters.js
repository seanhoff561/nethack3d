...
N.buildHero=function(r,p){
 ...
 if(a.weapon==='sword'){held('cyl','leather',[.03,-.29,.1],[.025,.19,.025]);held('box','gold',[.03,-.17,.1],[.22,.035,.055]);held('box','metal',[.03,.22,.1],[.063,.57,.021]);held('cone','metal',[.03,.57,.1],[.032,.11,.017]);}
 if(a.weapon==='katana'){held('box','metal',[.03,-.05,.1],[.045,.7,.022],[0,0,-.2]);held('box','gold',[.03,-.29,.1],[.18,.03,.055]);}
 if(a.weapon==='daggers'){held('box','metal',[.03,-.05,.1],[.045,.30,.022]);held('box','gold',[.03,-.19,.1],[.18,.03,.055]);r.mesh('box','metal',left,[0,-.13,.1],[.045,.38,.022]);}
